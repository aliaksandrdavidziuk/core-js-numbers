...
function roundToPowerOfTen(num, pow) {
  const value = Math.round(num / 10 ** pow);
  return value * 10 ** pow;
}
...
function getSumOfNumbers(x1, x2, x3) {
  let sum = 0;
  sum = parseFloat(x1) + parseFloat(x2) + parseFloat(x3);
